namespace Notes.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        GivenNames = c.String(nullable: false, maxLength: 100),
                        BirthDate = c.DateTime(nullable: false),
                        HireDate = c.DateTime(nullable: false),
                        OU = c.String(nullable: false, maxLength: 100),
                        ManagerId = c.Int(),
                        Photo = c.Binary(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Notes", "Employee_Id", "dbo.Employees");
            ...
            DropIndex("dbo.Notes", new[] { "Employee_Id" });
